...
import MiniProject_Backend as backend
...
class Movie:
    def __init__(self, root):
        ...
        def updata():
            if len(Movie_ID.get()) != 0:
                backend.UpdateMovieData(sd[0], Movie_ID.get(), Movie_Name.get(), Release_Date.get(), Director.get(), Cast.get(), Budget.get(), Duration.get(), Rating.get())
                disdata()
        ...
        self.lblBudget = Label(DFrameL, font=('Arial', 18, 'bold'), text="Budget:", padx=2, pady=2, bg="black", fg="orange")
        ...
        self.lblRating = Label(DFrameL, font=('Arial', 18, 'bold'), text="Rating:", padx=2, pady=2, bg="black", fg="orange")
        ...
        self.lblDuration = Label(DFrameL, font=('Arial', 18, 'bold'), text="Duration:", padx=2, pady=2, bg="black", fg="orange")
